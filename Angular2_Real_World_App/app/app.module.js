...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [app_component_1.AppComponent, navbar_component_1.NavBarComponent, not_found_component_1.NotFoundComponent, home_page_component_1.HomePageComponent, table_component_1.TableComponent, user_form_component_1.UserFormComponent],
            bootstrap: [app_component_1.AppComponent],
            providers: [user_service_1.UserService, forms_2.FormBuilder, user_validator_1.EmailValidator, prevent_unsaved_changes_guard_service_1.PreventUnsavedChangesGuard]
        }), 
